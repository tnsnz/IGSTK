...
namespace igstk
{
	...
	void View::beforeAddObject(bool f)
	{
		isCurrentRepPickable = f;
	}

	void View::afterAddObject()
	{
		isCurrentRepPickable = false;
	}
	...
	void View::RequestAddObject(ObjectRepresentation* pointer, bool pickable)
	{
	...
	void View::AddObjectProcessing()
	{
		...
		{
			(*actorIt)->SetPickable(isCurrentRepPickable);
